      ...
      <div className="row">
        ...
        col-sm-12 res_md_mb_40">
          ...
          data-animation="fadeInRight"
            ...
            <ul className="list_none list_chart
            text-center">
              <li>
        ...
        <div className="col-lg-6 col-md-12 col-sm-12">
          <div className="title_default_light
          title_border text-center">
            <h4 className="animation"data-animation="fadeInRight"
            data-animation-delay="0.2s"
            >
              Token Distribution
            </h4>
          ...
          data-animation="fadeInRight"
            data-animation-delay="0.2s">
              <img src="assets/images/distribution3.png"
              alt=""
              />
            </div>
            <div className="divider small_divider"></div>
