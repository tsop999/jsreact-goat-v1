...
const Footer = () => {
  const footerList = [
    "CryptoCash", "How it works", "Token", "FAQ", "Contact"
  ];
          ...
          <div className="row">
            ...
            <div className="col-lg-5 col-md-6 res_md_mt_30 res_sm_mt_20">
              <div className="newsletter_form">
                ...
                <form action="#" className="subscribe_from animation" data-animation="fadeInUp" data-animation-delay="0.4s">
                  <input
                    type="text"
                    required
