            ...
            <div className="col-lg-6 col-md-12 col-sm-1 order-lg-first">
              <div className="banner_text_s2 text_md_center">
                <h1 className="animation text-white" data-animation="fadeInUp" data-animation-delay="1.1s">
                  <strong>Bitcoin</strong> is peer to peer innovative <strong>network</strong>
                </h1>
                ...
                <a href="https://example.com/assets/doc/whitepaper.pdf" target="_blank" rel="noopener noreferrer" className="btn btn-default btn-radius nav-link content-popup">
